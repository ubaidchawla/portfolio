...
if ($name == "") {
    ...
    $headers .= 'From:  Papr <ubaid@chawla.systems>' . "\r\n";
    $headers .= 'cc: ubaid@chawla.systems' . "\r\n";
    $headers .= 'bcc: ubaid@chawla.systems' . "\r\n";
    mail($to, $subject, $_message, $headers, '-f ubaid@chawla.systems');
